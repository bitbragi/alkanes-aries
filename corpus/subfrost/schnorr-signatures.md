...
source: subfrost
source_url: https://docs.subfrost.io/key-components/schnorr-signatures
---
...
## What is a Digital Signature?[​](#what-is-a-digital-signature "Direct link to What is a Digital Signature?")
...
## Advantages of Schnorr Signatures[​](#advantages-of-schnorr-signatures "Direct link to Advantages of Schnorr Signatures")
...
### Linearity[​](#linearity "Direct link to Linearity")
...
### Smaller Size[​](#smaller-size "Direct link to Smaller Size")
...
### Provable Security[​](#provable-security "Direct link to Provable Security")
...
## Schnorr Signatures in SUBFROST[​](#schnorr-signatures-in-subfrost "Direct link to Schnorr Signatures in SUBFROST")
...
### `frBTC` and `dxBTC` Tokens[​](#frbtc-and-dxbtc-tokens "Direct link to frbtc-and-dxbtc-tokens")
...
### The `schnorrkel` Crate[​](#the-schnorrkel-crate "Direct link to the-schnorrkel-crate")
...
-   [Advantages of Schnorr Signatures](#advantages-of-schnorr-signatures)
    -   [Linearity](#linearity)
    -   [Smaller Size](#smaller-size)
    -   [Provable Security](#provable-security)
-   [Conclusion](#conclusion)
-   [Schnorr Signatures in SUBFROST](#schnorr-signatures-in-subfrost)
    -   [`frBTC` and `dxBTC` Tokens](#frbtc-and-dxbtc-tokens)
    -   [The `schnorrkel` Crate](#the-schnorrkel-crate)