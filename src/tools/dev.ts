...
import { NUDGE_OK } from "./nudge.js";

// Scaffolds are prime "I learned a gotcha" territory — nudge as a separate block.
const text = (s: string) => ({ content: [{ type: "text" as const, text: s }, NUDGE_OK] });
